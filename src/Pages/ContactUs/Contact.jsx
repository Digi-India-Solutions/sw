            ...
            <div className="all-addresses">
              <div>
                <h4>
                  <b> Regd. Address :</b>
                  <p>
                    Plot No. 50, Pkt. I, Sector-4 Bawana
                    Industrial Area, Delhi - 110039 E mail: swlifecare17@gmail.com
                    Customercare No. +91-9870405515
                    Web: www.swhealthcares co
                  </p>
                </h4>
              </div>
              <div>
                <h4>
                  <b> Raipur Branch :</b>
                  <p>
                    D-29, Devendra Nagar Hemukalyani Ward, Raipur
                    Chattisgarh - 492001
                  </p>
                </h4>
              </div>
              <div>
                <h4>
                  <b> Indore Branch :</b>
                  <p>
                    42-43, 4th Floor, (D.B.) 13-14 Tagore Centre, RNT Marg,
                    Indore-452001
              ...
              <div>
                <h4>
                  <b> Manufacturing Unit-2  :</b>
                  <p>
                    VISMED HEALTH CARE PVT. LTD.
                    Khasra No. 218/2/1, 1st Floor, Sanwer, Mangaliya Road, Todi, Indore, Madhya Pradesh, 453771
                  </p>
                </h4>
              </div>
              <div>
                <h4>
                  <b> Manufacturing Unit-1  :</b>
                  <p>
                    Plot No. 50, Pkt. I, Sector-4
